...
const AnsibleIcon = ({supported, className, ...props}) => {
    ...
    if (!supported) {
        unsupported =
        <React.Fragment>
            <rect x="1245.1" y="272.4" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 3082.5815 -510.474)" className="st0" width="803.8" height="221.5"/>
            <rect x="-279.7" y="904" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 2450.9683 1014.3757)" className="st1" width="2590.2" height="221.5"/>
            <rect x="17.1" y="1620.5" transform="matrix(-0.7071 0.7071 -0.7071 -0.7071 1734.4641 2744.1697)" className="st0" width="563.7" height="221.5"/>
        </React.Fragment>;
        ariaLabels = {
            ['disabled']: 'disabled',
    ...
    return (
        <i className= { ansibleLogoClass } {...ariaLabels}>
