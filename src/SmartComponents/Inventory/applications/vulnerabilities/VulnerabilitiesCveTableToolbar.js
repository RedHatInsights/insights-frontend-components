...
const CVSSOptions = [
    ...
    { value: '0to3', label: 'CVSS < 3.0', disabled: false, from: '', to: 3 },
    { value: '3to6', label: 'CVSS >= 3.0 and CVSS < 7.0', disabled: false, from: 3, to: 6 },
    { value: '7to10', label: 'CVSS >= 7.0 and CVSS <= 10.0', disabled: false, from: 7, to: 10 }
];
